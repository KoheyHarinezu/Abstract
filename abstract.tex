...
\author{
	\begin{tikzpicture}
		...
		% \draw[line width=1.4pt] (0,-0.525)--(16,-0.525)--(16,3.15)--(0,3.15)--cycle; %題目改行ver
		\draw[line width=1.4pt] (0,1.05)--(16,1.05);
		\draw[line width=1.4pt] (0,2.10)--(16,2.10);
		\draw[line width=1.4pt] (2.49,0)--(2.49,3.15);
		% \draw[line width=1.4pt] (2.49,-0.525)--(2.49,3.15);　%題目改行ver
		...
		% \draw(1.245,0.525-0.2625) circle(0) node{題目};　%題目改行ver
		...
		\draw(1.245+8,0.525) circle(0) node[bag]{
		% 題目を書く
			ABCDEFG
		};
		% \draw(1.245+8,0.525-0.2625) circle(0) node[bag]{
		% % 題目を書く 改行ver
		% 	ABCD\\
		% 	EFG
		% };
